...
$$
\frac{dw}{dt} = \frac{\partial w}{\partial x}\frac{dx}{dt} + \frac{\partial w}{\partial y}\frac{dy}{dt} = 0
$$

Now let's say, at the point we are interested in, we have gradient $\langle a,b\rangle$:

$$
\nabla w = \left\langle \frac{\partial w}{\partial x}, \frac{\partial w}{\partial y} \right\rangle = \langle a,b\rangle
$$
...
$$
b\frac{dy}{dt} = -a\frac{dx}{dt}
$$

Dividing through gives:

$$
\frac{dy/dt}{dx/dt} = -\frac{a}{b}
$$
...
Therefore, its slope is given by:
...
$$
\langle a,b\rangle \cdot \langle -b,a\rangle = -ab + ab = 0
$$
